...
// 窗体
#define WINDOW_TITLEBARHEIGHT 30 // 标题栏高度
#define WINDOW_WIDTH 600        // 游戏窗口宽度
#define WINDOW_HEIGHT 901       // 游戏窗口高度

// 计时器
#define TIMER_GAMETIMER 1          // 游戏的默认计时器ID
#define TIMER_GAMETIMER_ELAPSE 15  // 默认计时器刷新间隔的毫秒数
#define TIMER_PAINTTIMER 2          // 游戏的默认计时器ID
#define TIMER_PAINTTIMER_ELAPSE 20  // 默认计时器刷新间隔的毫秒数
#define TIMER_CONTROLTIMER 3          // 游戏的默认计时器ID
#define TIMER_CONTROLTIMER_ELAPSE 50  // 默认计时器刷新间隔的毫秒数
...
#define HEAD_HEIGHT 360
#define HEAD_HEIGHT_Y HEAD_HEIGHT/BG_CELL_HEIGHT
#define BG_COLUMNS  WINDOW_WIDTH / BG_CELL_WIDTH // 背景沿X方向的单元个数
#define BG_ROWS (WINDOW_HEIGHT-HEAD_HEIGHT) / BG_CELL_HEIGHT  // 背景沿Y方向的单元个数

// 砖块
#define BRICK_CELL_WIDTH 30                          // 砖块单格宽度
#define BRICK_CELL_HEIGHT 30                     // 砖块单格高度
...
#define BUTTON_STARTGAME_WIDTH 343                                            // 开始游戏按钮宽度
#define BUTTON_STARTGAME_HEIGHT 118                                           // 开始游戏按钮高度
...
//添加边界线函数
void CreateBorderLine(HBITMAP img);
